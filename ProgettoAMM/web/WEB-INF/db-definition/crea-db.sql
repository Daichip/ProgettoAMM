--DB: NerdBase ; User: Daichip ; password: DataPass--
...
(
    ...
    FOREIGN KEY (tipo) REFERENCES postType(idTipoPost)
);

CREATE TABLE TipoPost
(
    idTipoPost INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    nameTipoPost posttype_name VARCHAR(32)
);
...
INSERT INTO Post (idPost, autore, contenuto, tipo)
VALUES (default,
        0,
        'Mamma mia!',
        1);
