                ...
                */
                ...
                if(thereIsPost.equals("needConfirm")){
                    ...
                    if(type.equals("textType"))
                        post.setTipo(Post.TipoPost.TEXT);
                    else
                        post.setTipo(Post.TipoPost.IMAGE);
                    
                    post.setAutore(UtentiFactory.getInstance().getUtenteById((Integer)session.getAttribute("loggedUserID")));
                    PostFactory.getInstance().inserisciPost(post);
